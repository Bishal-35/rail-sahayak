      ...
      try {
        ...
        if (user != null) {
          ...
          Map<String, dynamic> bookingData = {
            ...
            'status': 'pending',
            'service_type': 'wheelchair', // Add service type for API
          };
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Wheelchair booked successfully!'),
            ...
            Expanded(
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 4),
                  Text(
                    'Book wheelchair for passengers',
                    style: TextStyle(
                      fontSize: 13,
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Book Wheelchair Button
                    SizedBox(
                      width: double.infinity,
                      height: 48,
                      child: ElevatedButton(
                        onPressed: _isLoading ? null : _bookWheelChair,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoPoint('Wheelchair service is free of charge'),
                  const SizedBox(height: 8),
                  _buildInfoPoint(
                    'Please be at the specified location 10 minutes before the scheduled time',
                  ),
                  const SizedBox(height: 8),
                  _buildInfoPoint(
                    'Attendant will assist you with the wheelchair',
                  ),
                  const SizedBox(height: 8),
                  _buildInfoPoint('Service is subject to availability'),
                ],
              ),
            ),
          ],
