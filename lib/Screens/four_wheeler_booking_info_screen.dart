...
class FourWheelerBookingInfoScreen extends StatefulWidget {
  final Map<String, dynamic> bookingData;

  const FourWheelerBookingInfoScreen({super.key, required this.bookingData});

  @override
  _FourWheelerBookingInfoScreenState createState() =>
      _FourWheelerBookingInfoScreenState();
}

class _FourWheelerBookingInfoScreenState
    extends State<FourWheelerBookingInfoScreen> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            "Are you sure you want to cancel your 4-Wheeler Cart booking?",
              ...
              onPressed: () {
                ...
                _updateStatus('Cancelled').then((_) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        '4-Wheeler Cart booking successfully cancelled',
                      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("4-Wheeler Cart Booking Information")),
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                infoRow(
                  Icons.luggage,
                  "Luggage Count : ${data['luggageCount'] ?? '0'}",
                ),
                infoRow(
                ...
                if (currentStatus == 'pending')
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () => _updateStatus('Cart Assigned'),
                      child: Text(
                        "Cart Assigned",
                ...
                else if (currentStatus == 'Cart Assigned')
                  SizedBox(
                    width: double.infinity,
                    height: 48,
                    child: ElevatedButton(
